...
//
// ASCOM Telescope driver for ArduinoDriverEQ
//
...
{
    //
    // Your driver's DeviceID is ASCOM.ArduinoDriverEQ.Telescope
    //
    // The Guid attribute sets the CLSID for ASCOM.ArduinoDriverEQ.Telescope
    // The ClassInterface/None addribute prevents an empty interface called
    // _ArduinoDriverEQ from being created and used as the [default] interface
    //
    ...
    public class Telescope : ITelescopeV3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArduinoDriverEQ"/> class.
            ...
            set
            {
                ...
                if (value)
                {
                    ...
                    try
                    {
                        ...
                        serialPort.Speed = SerialSpeed.ps57600;  // speed for comport
